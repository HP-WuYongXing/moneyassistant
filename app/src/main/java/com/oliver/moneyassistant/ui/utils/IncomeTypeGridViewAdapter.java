 ...
 */
public class IncomeTypeGridViewAdapter extends BaseAdapter{

    private Context context;
    private List<IncomeType> list;

    public IncomeTypeGridViewAdapter(Context context, List<IncomeType> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        IncomeType type = list.get(position);
